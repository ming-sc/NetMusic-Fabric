package com.sedmellug.discord.lavaplayer.format;
...
public class AudioPlayerInputStream extends InputStream {
     ...
     *                       read times out.
     */
    public AudioPlayerInputStream(AudioDataFormat format, AudioPlayer player, long timeout, boolean provideSilence) throws IOException {
        this.format = format;
        this.player = player;
    ...
    public static AudioInputStream createStream(AudioPlayer player, AudioDataFormat format, long stuckTimeout, boolean provideSilence) {
        ...
        return new AudioInputStream(new com.sedmelluq.discord.lavaplayer.format.AudioPlayerInputStream(format, player, stuckTimeout, provideSilence), jdkFormat, -1);
    }
